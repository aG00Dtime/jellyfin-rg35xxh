...
$required = @('jellyfinrg35xx/jellyfin_rg35xx.py','jellyfinrg35xx/playback.py','jellyfinrg35xx/library.py','jellyfinrg35xx/ui.py','jellyfinrg35xx/config.example.json','jellyfinrg35xx/assets/jellyfin-icon.png','gameinfo.xml','Jellyfin RG35XX.sh','port.json','README.md')
